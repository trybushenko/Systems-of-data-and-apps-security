...
class Window2(QMainWindow):
    def __init__(self):
        ...
        self.setWindowTitle("Ви увійшли як адміністратор")
        self.label_2 = QLabel(self)
        self.label_2.setText("Адміністратор має права на читання,\nзапис і виконання (rwx)")
        self.label_2.setFont(QtGui.QFont("Times", 12))
        self.label_2.setAlignment(QtCore.Qt.AlignCenter)
        self.label_2.setGeometry(QtCore.QRect(0, 0, 400, 50))
        self.label_2.move(100, 30)
        ...
        self.button_pwd.setFont(QtGui.QFont("Times", 12))
        ...
        self.button_ls.setFont(QtGui.QFont("Times", 12))
        ...
        self.button_cd.setFont(QtGui.QFont("Times", 12))
        ...
        self.button_mkdir.setFont(QtGui.QFont("Times", 12))
        ...
        self.button_vi.setFont(QtGui.QFont("Times", 12))
        ...
        self.button_rm.setFont(QtGui.QFont("Times", 12))
    ...
    def cd(self):
        try:
            ...
            self.error("Введіть, будь ласка, шлях до потрібної папки!")

    def mkdir(self):
        self.input_values()
        parent_dir = os.getcwd()
        directory = self.mkdir_received
        path = os.path.join(parent_dir, directory)
        os.mkdir(path)

    def vi(self):
        self.input_values()
        f = open(str(self.vi_received), 'w')
        f.close()
        file = str(self.vi_received)
        webbrowser.open(file)

    def rm(self):
        try:
            self.input_values()
            os.remove(self.rm_received)
        except:
            try:
                os.rmdir(self.rm_received)
            except:
                self.error("Вказаної папки або файла не існує.")
